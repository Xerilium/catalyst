...
5. Execute @node_modules/@xerilium/catalyst/playbooks/actions/auq.md to present full spec for final approval. Repeat steps 1–5 for each feature in scope; in `autonomous-branch` execution mode, commit after each feature approval.
